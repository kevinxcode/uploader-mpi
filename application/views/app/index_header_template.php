		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-row flex-column-fluid page">
				...
				<div class="aside aside-left d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<li class="menu-item menu-item-submenu <?php if($current_page == "nagoya") {echo "menu-item-open menu-item-here";} ?>" aria-haspopup="true" data-menu-toggle="hover">
						<a href="javascript:;" class="menu-link menu-toggle">
							<span class="svg-icon menu-icon">
								<!--begin::Svg Icon | path:assets/media/svg/icons/Shopping/Box2.svg-->
								<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
						...
						<div class="menu-submenu">
							...
							<ul class="menu-subnav">
								...
								<li class="menu-item <?php if($sub_page == "nagoya_data_cetak") {echo "menu-item-active";} ?>" aria-haspopup="true">
								...
								<li class="menu-item <?php if($sub_page == "nagoya_kas") {echo "menu-item-active";} ?>" aria-haspopup="true">
								...
								<li class="menu-item <?php if($sub_page == "nagoya_pengeluaran") {echo "menu-item-active";} ?>" aria-haspopup="true">
					...
					<li class="menu-item menu-item-submenu <?php if($current_page == "express") {echo "menu-item-open menu-item-here";} ?>" aria-haspopup="true" data-menu-toggle="hover">
						<a href="javascript:;" class="menu-link menu-toggle">
							<span class="svg-icon menu-icon">
								<!--begin::Svg Icon | path:assets/media/svg/icons/Shopping/Box2.svg-->
								<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
						...
						<div class="menu-submenu">
							...
							<ul class="menu-subnav">
								...
								<li class="menu-item <?php if($sub_page == "express_data_cetak") {echo "menu-item-active";} ?>" aria-haspopup="true">
								...
								<li class="menu-item <?php if($sub_page == "express_kas") {echo "menu-item-active";} ?>" aria-haspopup="true">
								...
								<li class="menu-item <?php if($sub_page == "express_pengeluaran") {echo "menu-item-active";} ?>" aria-haspopup="true">
					...
					<li class="menu-item menu-item-submenu <?php if($current_page == "mpi") {echo "menu-item-open menu-item-here";} ?>" aria-haspopup="true" data-menu-toggle="hover">
						<a href="javascript:;" class="menu-link menu-toggle">
							<span class="svg-icon menu-icon">
								<!--begin::Svg Icon | path:assets/media/svg/icons/Shopping/Box2.svg-->
								<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
						...
						<div class="menu-submenu">
							...
							<ul class="menu-subnav">
								...
								<li class="menu-item <?php if($sub_page == "mpi_data_cetak") {echo "menu-item-active";} ?>" aria-haspopup="true">
								...
								<li class="menu-item <?php if($sub_page == "mpi_kas") {echo "menu-item-active";} ?>" aria-haspopup="true">
								...
								<li class="menu-item <?php if($sub_page == "mpi_pengeluaran") {echo "menu-item-active";} ?>" aria-haspopup="true">
					...
					<li class="menu-item menu-item-submenu <?php if($current_page == "pos") {echo "menu-item-open menu-item-here";} ?>" aria-haspopup="true" data-menu-toggle="hover">
						<a href="javascript:;" class="menu-link menu-toggle">
							<span class="svg-icon menu-icon">
								<!--begin::Svg Icon | path:assets/media/svg/icons/Shopping/Box2.svg-->
								<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
							...
							<span class="menu-text">MPI POS</span>
							<i class="menu-arrow"></i>
						</a>
						<div class="menu-submenu">
							<i class="menu-arrow"></i>
							<ul class="menu-subnav">
								...
								<li class="menu-item <?php if($sub_page == "pos_data_cetak") {echo "menu-item-active";} ?>" aria-haspopup="true">
									<a href="<?php echo prefix_url;?>pos/order" class="menu-link">
										<i class="menu-bullet menu-bullet-dot">
											<span></span>
										</i>
											<span class="menu-text">DATA CETAK</span>
								...
								<li class="menu-item <?php if($sub_page == "pos_kas") {echo "menu-item-active";} ?>" aria-haspopup="true">
									<a href="<?php echo prefix_url;?>pos/kas" class="menu-link">
										<i class="menu-bullet menu-bullet-dot">
											<span></span>
										</i>
											<span class="menu-text">KAS HARIAN</span>
								...
								<li class="menu-item <?php if($sub_page == "pos_pengeluaran") {echo "menu-item-active";} ?>" aria-haspopup="true">
									<a href="<?php echo prefix_url;?>pos/pengeluaran_view" class="menu-link">
										<i class="menu-bullet menu-bullet-dot">
											<span></span>
										</i>
											<span class="menu-text">PENGELUARAN</span>
