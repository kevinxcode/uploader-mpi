							...
							<div class="container">
								...
								<div class="card card-custom">
									<div class="card-header flex-wrap py-2">
										<form action="<?php echo base_url(); ?>express/pengeluaran_view"  method="get" enctype="multipart/form-data">
...
<form action="<?php echo base_url(); ?>express/upload_pengeluaran"  method="post" enctype="multipart/form-data">
